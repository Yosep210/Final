...
final class RoTable extends PowerGridComponent
{
    public string $tableName = 'roTable';
    ...
    public function datasource(): Builder
    {
        ...
        return ProductOrder::query()
            ...
            ->where('product_orders.type_order', 'manual_ro')
            ->select([
                'product_orders.*',
    ...
    public function columns(): array
    {
        return [
            Column::make('#', 'no'),
            Column::make('Tanggal RO', 'created_at_formatted', 'product_orders.created_at')->sortable(),
