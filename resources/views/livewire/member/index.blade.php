        ...
        <div class="space-y-6">
            ...
            <form wire:submit="save" class="space-y-6">
                <div class="grid gap-4 md:grid-cols-2">
                    ...
                    <flux:select
                        wire:key="member-country-{{ $showModal ? 'open' : 'closed' }}-{{ $profile['country_id'] ?? 'none' }}"
                        wire:model.live="profile.country_id" :label="__('Country')">
                    ...
                    <div class="space-y-2">
                        <label class="text-sm font-medium text-zinc-700 dark:text-zinc-300">{{ __('Phone/WhatsApp')
                            }}</label>
                        <div class="flex gap-2">
                            <div
                                class="w-24 flex items-center px-3 border border-zinc-300 dark:border-zinc-600 rounded-lg bg-zinc-50 dark:bg-zinc-800">
                                <span class="text-sm font-medium text-zinc-600 dark:text-zinc-400">{{ $phoneCode ?? '+'
                                    }}</span>
                            </div>
